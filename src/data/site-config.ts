  ...
  apropos: {
    ...
    bio: {
      ...
      paragraphes: [
        ...
        "Ma passion pour l'intelligence artificielle est née d'un déclic : l'École d'Été en Intelligence Artificielle (EEIA 2025) de la Fondation Vallet, où j'ai découvert le Machine Learning et une vision claire de ce que je veux devenir : Research Scientist en intelligence artificielle au sein de la R&D des grandes entreprises technologiques mondiales, avec l'ambition, à terme, d'évoluer vers la direction stratégique de l'IA (Director of AI / Technical Product Manager). Depuis, je construis chaque projet (réseau, logiciel ou data/IA) comme une étape vers cette trajectoire.",
        "Curieux, je m'appuie sur la recherche avant de me lancer ; rigoureux, j'analyse les exigences avant de concevoir ; autonome, je mène mes projets de bout en bout, de la conception à l'implémentation. Cette même exigence, je la mets au service du collectif : Secrétaire Général de l'Organe de Contrôle du H3CP par le passé, j'y ai appliqué la même rigueur à la coordination de mes pairs qu'à mes projets techniques. En dehors des projets techniques, sport et lecture m'aident à garder l'esprit vif. Mon objectif prioritaire est de décrocher une bourse d'excellence pour poursuivre une formation d'ingénieur de haut niveau, mais je reste ouvert à toute opportunité qui m'en rapproche (stage, poste, projet ou mission freelance) pour me permettre de concrétiser mon rêve d'intégrer la R&D d'une grande entreprise technologique mondiale en tant que Research Scientist en intelligence artificielle, avec, à long terme, l'ambition d'évoluer vers la direction stratégique de l'IA, puis de créer des startups à fort impact en Afrique.",
      ],
